...
class UYDGoogle_Config
{
  ...
  public function __construct($ini_file_location = null)
  {
    $this->configuration = array(
      ...
      'classes' => array(
        'UYDGoogle_IO_Abstract' => array(
          'request_timeout_seconds' => 90,
        ),
        'UYDGoogle_IO_Curl' => array(
          'disable_proxy_workaround' => false,
          'options' => null,
        ),
        'UYDGoogle_Logger_Abstract' => array(
          'level' => 'debug',
          'log_format' => "[%datetime%] %level%: %message% %context%\n",
          'date_format' => 'd/M/Y:H:i:s O',
          'allow_newlines' => true
        ),
        'UYDGoogle_Logger_File' => array(
          'file' => 'php://stdout',
          'mode' => 0640,
          'lock' => false,
        ),
        'UYDGoogle_Http_Request' => array(
        ...
        'UYDGoogle_Service_Exception' => array(
          'retry_map' => array(
